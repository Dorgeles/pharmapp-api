...
/**
 * DTO customize for table "prix_medicament"
 * 
...
public class _PrixMedicamentDto implements Cloneable {
	...
	public SearchParam<String> getPrixUnitaireParam() {
		return prixUnitaireParam;
	}

	public void setPrixUnitaireParam(SearchParam<String> prixUnitaireParam) {
	...
	protected SearchParam<String>   prixUnitaireParam     ;                     
