...
/**
 * DTO customize for table "ordonnance"
 * 
...
public class _OrdonnanceDto implements Cloneable {
	...
	public SearchParam<String> getDateEmissionParam() {
		return dateEmissionParam;
	}

	public void setDateEmissionParam(SearchParam<String> dateEmissionParam) {
		this.dateEmissionParam = dateEmissionParam;
	}
	...
	protected SearchParam<String>   dateEmissionParam     ;                     
